...
void lcd_vid_write_charachter (u8 data) {
     ...
     dio_vid_set_pin_value(E, 1, 1);
 dio_vid_set_port_value(D, data);

 dio_vid_set_pin_value(E, 2, 1);
     _delay((unsigned long)((3)*(8000000/4000.0)));


 dio_vid_set_pin_value(E, 1, 0);
 _delay((unsigned long)((3)*(8000000/4000.0)));
 dio_vid_set_pin_value(E, 1, 1);
...
void lcd_vid_write_command (u8 command) {
     ...
     dio_vid_set_pin_value(E, 1, 1);
 dio_vid_set_port_value(D, command);

 dio_vid_set_pin_value(E, 2, 0);
...
void lcd_vid_init(void) {
 ...
 lcd_vid_write_command(0x0F);
 lcd_vid_write_command(0x01);
 lcd_vid_write_command(0x38);
        lcd_vid_write_command(0x80);
